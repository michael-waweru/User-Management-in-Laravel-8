@csrf
    ...
    <div class="mb-3">
        ...
        <input name="email" type="email" class="form-control @error('email') is-invalid @enderror"" id="email" ari0a-describedby="email"
    ...
    <div class="mb-3">
        @foreach ($roles as $role)
            <div class="form-check">
                <input type="checkbox" name="roles[]" classs="form-check-input" value="{{ $role->id }}" id="{{ $role->name }}">
